...
public class MLHUIMinerTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== TEST 1: KIỂM TRA HUI (Mức sản phẩm) ===");
        ...
        // Kiểm tra tập {Steak, Coke}
        List<String> huiCandidate3 = Arrays.asList("Steak","Coke");
        int util5 = calculateItemsetUtility(huiCandidate3);
        printResult(huiCandidate3.toString(),util5,minUtilHUI);
        
        //Kiể tra tập {Steak}
        List<String> huiCandidate4 = Arrays.asList("Steak");
        int util6 = calculateItemsetUtility(huiCandidate4);
        printResult(huiCandidate4.toString(),util6,minUtilHUI);

        System.out.println("\n=== TEST 2: KIỂM TRA GHUI (Mức tổng quát) ===");
        ...
        //Kiểm tra tập {Food} 
        List<String> ghuiCandidate1 = Arrays.asList("Food");
        int util7= calculateItemsetUtility(ghuiCandidate1);
        printResult(ghuiCandidate1.toString(),util7,minUtilGHUI);
    }
