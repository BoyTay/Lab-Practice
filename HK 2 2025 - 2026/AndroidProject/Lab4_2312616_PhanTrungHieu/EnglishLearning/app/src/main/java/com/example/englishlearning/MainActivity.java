...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        for (int i = 0; i < ID_DRAWABLES.length; i++) {
            ...
            // Xử lý sự kiện click: mở VocabularyActivity hiển thị từ vựng theo chủ đề
            final int topicIndex = i;
            v.setOnClickListener(view -> {
                Intent intent = new Intent(MainActivity.this, VocabularyActivity.class);
                intent.putExtra(VocabularyActivity.EXTRA_TOPIC_INDEX, topicIndex);
                intent.putExtra(VocabularyActivity.EXTRA_TOPIC_NAME, getString(ID_TEXTS[topicIndex]));
